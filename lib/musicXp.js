...
// music_answer_logs, music_lesson_progress (xem music-schema.sql).
import { supabase } from './supabaseClient';

// ⚠️ CẦN ĐIỀN: id môn Âm nhạc trong bảng "subjects" (dùng chung với Tiếng
// Anh). Chạy insert + select ở cuối music-schema.sql rồi dán id vào đây —
// để trống/sai thì bước ghi XP (bước 5-7 bên dưới) sẽ báo lỗi khoá ngoại.
export const MUSIC_SUBJECT_ID = 'DÁN_UUID_MÔN_ÂM_NHẠC_VÀO_ĐÂY';
