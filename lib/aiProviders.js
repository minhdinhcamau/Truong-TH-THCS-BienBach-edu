...
// Gemini: dùng Interactions API (v1beta2/interactions) — đây là API mà Google khuyến nghị và là API
// được xác nhận hoạt động đúng với khóa kiểu mới "AQ.Ab..." (Auth key, mặc định từ 28/5/2026).
// Nhiều báo cáo cho thấy API cũ (generateContent) trả lỗi 401 với khóa AQ khi gọi trực tiếp bằng REST,
// nên ở đây dùng thẳng Interactions API để tránh lỗi đó với cả khóa cũ (AIzaSy...) lẫn khóa mới (AQ.Ab...).
